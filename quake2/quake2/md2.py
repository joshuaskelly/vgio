...
def _check_md2file(fp):
    ...
    return identity is b'IDP2' and version is 8
...
class Md2:
    ...
    def _read_file(file, mode):
        ...
        md2.st_vertexes = _read_chunk(StVertexes, header.st_vertex_offset, header.number_of_st_vertexes)
        md2.triangles = _read_chunk(Triangles, header.triangle_offset, header.number_of_triangles)
    ...
    def save(self, file):
        ...
        Raises:
            ...
            BadMd2File: If the internal Mdl data is not invalid.
        """
