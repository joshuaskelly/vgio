...
class TestBspReadWrite(unittest.TestCase):
    ...
    def test_plane(self):
        ...
        bsp.BspPlane.write(self.buff, p0)
        self.buff.seek(0)

        p1 = bsp.BspPlane.read(self.buff)
    ...
    def test_miptexture(self):
        ...
        bsp.BspMiptexture.write(self.buff, m0)
        self.buff.seek(0)

        m1 = bsp.BspMiptexture.read(self.buff)
    ...
    def test_vertex(self):
        ...
        bsp.BspVertex.write(self.buff, v0)
        self.buff.seek(0)

        v1 = bsp.BspVertex.read(self.buff)
    ...
    def test_node(self):
        ...
        bsp.BspNode.write(self.buff, n0)
        self.buff.seek(0)

        n1 = bsp.BspNode.read(self.buff)
    ...
    def test_textureinfo(self):
        ...
        bsp.BspTextureInfo.write(self.buff, t0)
        self.buff.seek(0)

        t1 = bsp.BspTextureInfo.read(self.buff)
    ...
    def test_face(self):
        ...
        bsp.BspFace.write(self.buff, f0)
        self.buff.seek(0)

        f1 = bsp.BspFace.read(self.buff)
    ...
    def test_clipnode(self):
        ...
        bsp.BspClipNode.write(self.buff, c0)
        self.buff.seek(0)

        c1 = bsp.BspClipNode.read(self.buff)
    ...
    def test_leaf(self):
        ...
        bsp.BspLeaf.write(self.buff, l0)
        self.buff.seek(0)

        l1 = bsp.BspLeaf.read(self.buff)
    ...
    def test_edge(self):
        ...
        bsp.BspEdge.write(self.buff, e0)
        self.buff.seek(0)

        e1 = bsp.BspEdge.read(self.buff)
    ...
    def test_model(self):
        ...
        bsp.BspModel.write(self.buff, m0)
        self.buff.seek(0)

        m1 = bsp.BspModel.read(self.buff)
