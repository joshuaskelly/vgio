...
class TestWadReadWrite(TestCase):
    ...
    def test_read(self):
        ...
        info = wad_file.getinfo('black')
        self.assertIsNotNone(info, 'FileInfo should not be None')
        self.assertEqual(info.filename, 'black')
        self.assertEqual(info.file_size, 1152, 'FileInfo size of test file should be 5480')
    ...
    def test_write(self):
        ...
        wad_file.write('./test_data/test.bsp', 'test.bsp')
